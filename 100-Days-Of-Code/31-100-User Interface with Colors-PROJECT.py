...
time.sleep(10)
os.system('cls')
#! Doesn't need to make each variables for print the output because the variable is automatically updated when the computer is reading the lines down
#! TLDR: The variables auto update when the computer is reading the lines down
text = "WELCOME TO"
